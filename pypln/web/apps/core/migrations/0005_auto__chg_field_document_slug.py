...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_document', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Document.slug'
        db.alter_column('core_document', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
    ...
    models = {
        ...
        'core.corpus': {
            'Meta': {'ordering': "('name',)", 'unique_together': "(('name', 'owner'),)", 'object_name': 'Corpus'},
