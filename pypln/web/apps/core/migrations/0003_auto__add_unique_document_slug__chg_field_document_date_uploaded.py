...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Document', fields ['slug']
        db.create_unique('core_document', ['slug'])


        # Changing field 'Document.date_uploaded'
        db.alter_column('core_document', 'date_uploaded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Removing unique constraint on 'Document', fields ['slug']
        db.delete_unique('core_document', ['slug'])


        # Changing field 'Document.date_uploaded'
        db.alter_column('core_document', 'date_uploaded', self.gf('django.db.models.fields.DateTimeField')())
